...
public class Film {
    ...
    public BigInteger getAddedDate() {
        return addedDate;
    }

    public void setAddedDate(BigInteger addedDate) {
    ...
    public Object getRelatedFilms() {
        return relatedFilms;
    }

    public void setRelatedFilms(Object relatedFilms) {
    ...
    public Object getFbCommentsUrl() {
        return fbCommentsUrl;
    }

    public void setFbCommentsUrl(Object fbCommentsUrl) {
    ...
    public String getViewerGrade() {
        return viewerGrade;
    }

    public void setViewerGrade(String viewerGrade) {
